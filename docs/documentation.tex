...
\begin{verbatim}
=== Demo de Entrenamiento de Red Neuronal a Gran Escala ===
Este demo entrena con un dataset sintético más grande para demostrar
el rendimiento en problemas más realistas (~2-3 minutos de entrenamiento)

Generando dataset sintético...
Muestras: 1000
Dimensiones de entrada: 10
Dimensiones de salida: 1
...
Tiempo total de entrenamiento: 156 segundos (2m 36s)

=== PRECISIÓN FINAL (Dataset Completo) ===
Precisión de Clasificación Binaria: 92.5% (925/1000 correctas)
Error Absoluto Medio (MAE): 0.0823
Precisión Numérica: 91.77%
===========================================
\end{verbatim}
